...
function IconOpenAI({ className, ...props }: React.ComponentProps<'svg'>) {
 ...
 width="86.000000pt" height="94.000000pt" viewBox="0 0 86.000000 94.000000"
...
function IconNextChat({
  ...
  return (
<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="110.000000pt" height="97.000000pt" viewBox="0 0 278.000000 97.000000"
 preserveAspectRatio="xMidYMid meet">
...
function IconOpenAI_org({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
...
function IconGitHub({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"  width="50" height="60" viewBox="-45 -30 90 60" fill="#2C2C6F">
